...
// Fatal takes a pointer subLogger struct & interface formats and sends to newLogEvent()
...
// Fatalln takes a pointer subLogger struct, string & interface formats and sends to newLogEvent()
func Fatalln(sl *SubLogger, v ...interface{}) {
	fields := getFields(sl)
	if fields == nil {
		return
	}
...
// Fatalf takes a pointer subLogger struct, string & interface formats and sends to Debug()
